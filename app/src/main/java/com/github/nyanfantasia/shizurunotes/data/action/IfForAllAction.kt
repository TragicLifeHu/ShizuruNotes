    ...
    override fun childInit() {
        ...
        if (actionDetail2 != 0) {
            if (actionDetail1 == 710 || actionDetail1 == 100 || actionDetail1 == 1700 || actionDetail1 == 1601) {
                ...
                trueClause = getString(
                    ...
                    actionDetail1, actionNum(actionDetail2)
                )
                ...
                trueClause = getString(
                    ...
                    actionNum(actionDetail2), targetParameter!!.buildTargetClause(), actionDetail1 - 700
                )
                ...
                trueClause = getString(
                    ...
                    actionNum(actionDetail1), actionNum(actionDetail2), actionDetail1 % 100 / 10
                )
        ...
        if (actionDetail3 != 0) {
            if (actionDetail1 == 710 || actionDetail1 == 100 || actionDetail1 == 1700 || actionDetail1 == 1601) {
                ...
                falseClause = getString(
                    R.string.d1_chance_use_d2,
                    100 - actionDetail1, actionNum(actionDetail3)
                )
            } else if (actionDetail1 in 500..512) {
                falseClause = getString(
                ...
                falseClause = getString(
                    ...
                    actionNum(actionDetail3), targetParameter!!.buildTargetClause(), actionDetail1 - 700
                )
            } else if (actionDetail1 == 720) {
                falseClause = getString(
                ...
                falseClause = getString(
                    ...
                    actionNum(actionDetail1), actionNum(actionDetail3), actionDetail1 % 100 / 10
                )
            } else if(actionDetail1 == 1800){
                trueClause = getString(
